...
class MoviesStoreTest: FunSpec(){
    val movie1 = Movie(releaseDate = Date(2018.toString()),
    ...
    val movie2 = Movie(releaseDate = Date(2010.toString()),
            actors = listOf("Akshay Kumar"),
            actresses = listOf("Katrina"),
    ...
    val movie3 = Movie(releaseDate = Date(2013.toString()),
            actors = listOf("Akshay Kumar"),
            actresses = listOf("Katrina"),
    ...
    val movie4 = Movie(releaseDate = Date(2018.toString()),
            actors = listOf("Akshay Kumar"),
            actresses = listOf("Katrina"),
    ...
    val movie5 = Movie(releaseDate = Date(2010.toString()),
    ...
    init {
        ...
        test("should give expected list of movies with given year"){
            val store = MoviesStore(movies)
            store.getMoviesReleasedInYear(2018.toString()) shouldBe listOf(movie1, movie4)
        }
        ...
        test("should give expected list of movies with given duration using lambda"){
            ...
            moviesStore shouldBe MoviesStore(mutableListOf(movie2))
        }

        test("should give expected list of movies with given year using lambda"){
            val store = MoviesStore(movies)
            val moviesStore = store.getStoreWithMovies { it.releaseDate == Date(2018.toString()) }
            moviesStore shouldBe MoviesStore(mutableListOf(movie1, movie4))
        }
    }
}